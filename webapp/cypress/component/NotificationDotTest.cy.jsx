    ...
    describe(`when isUnverified is ${isUnverified} and hasUnverifiedUser is ${hasUnverifiedUser}`, () => {
      ...
      it(`shows the correct tooltip message`, () => {
        if (tooltipText) {
          ...
          cy.get("[data-testid='notification-tooltip']").should("have.attr", "data-show");
          cy.get("[data-testid='notification-tooltip'] p").contains(tooltipText);
        } else {
          cy.get(".notification-dot").should("not.exist");
          cy.get("[data-testid='notification-tooltip']").should("not.have.attr", "data-show");
        }
      });
